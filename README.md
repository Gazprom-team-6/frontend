![Структура компании](src/assets/logo.svg)
...
[Проект](https://gazprom-team-6.github.io/frontend)
...
В нашем проекте мы использовали стильный и современный шрифт **Inter**. Этот шрифт помогает придать приложению уникальный и профессиональный вид. Можно найти [здесь](https://bestfonts.pro/font/inter).👌
...
`SCSS и CamelCase`: Наши стили - настоящие модники. Мы используем SCSS для того, чтобы стили были такими гладкими, как шелк, а названия функцирнальных компонентов придумываем в стиле "король верблюда" - CamelCase!
...
- `git clone https://github.com/Gazprom-team-6/frontend.git` - клонируйте репозиторий;
